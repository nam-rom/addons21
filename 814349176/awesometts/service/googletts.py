...
class GoogleTTS(Service):
    ...
    _voice_list = [
        ("af-ZA-Standard-A", "Afrikaans (af-ZA-Standard-A)"),
        ...
        ("ar-XA-Wavenet-D", "Arabic (ar-XA-Wavenet-D)"),
        ("bg-bg-Standard-A", "Bulgarian (bg-bg-Standard-A)"),
        ("bn-IN-Standard-A", "Bangla (bn-IN-Standard-A)"),
        ("bn-IN-Standard-B", "Bangla (bn-IN-Standard-B)"),
        ("bn-IN-Wavenet-A", "Bangla (bn-IN-Wavenet-A)"),
        ("bn-IN-Wavenet-B", "Bangla (bn-IN-Wavenet-B)"),
        ("ca-es-Standard-A", "Catalan (ca-es-Standard-A)"),
        ...
        ("de-DE-Standard-C", "German (de-DE-Standard-C)"),
        ("de-DE-Standard-D", "German (de-DE-Standard-D)"),
        ...
        ("en-US-Standard-A", "English, United States (en-US-Standard-A)"),
        ...
        ("en-US-Standard-F", "English, United States (en-US-Standard-F)"),
        ...
        ("es-ES-Standard-A", "Spanish, Spain (es-ES-Standard-A)"),
        ("es-ES-Standard-B", "Spanish, Spain (es-ES-Standard-B)"),
        ("es-ES-Wavenet-B", "Spanish, Spain (es-ES-Wavenet-B)"),
        ("es-US-Standard-A", "Spanish, United States (es-US-Standard-A)"),
        ("es-US-Standard-B", "Spanish, United States (es-US-Standard-B)"),
        ("es-US-Standard-C", "Spanish, United States (es-US-Standard-C)"),
        ("es-US-Wavenet-A", "Spanish, United States (es-US-Wavenet-A)"),
        ("es-US-Wavenet-B", "Spanish, United States (es-US-Wavenet-B)"),
        ("es-US-Wavenet-C", "Spanish, United States (es-US-Wavenet-C)"),
        ...
        ("gu-IN-Wavenet-A", "Gujarati (gu-IN-Wavenet-A)"),
        ("gu-IN-Wavenet-B", "Gujarati (gu-IN-Wavenet-B)"),
        ...
        ("is-is-Standard-A", "Icelandic (is-is-Standard-A)"),
        ...
        ("kn-IN-Wavenet-A", "Kannada (kn-IN-Wavenet-A)"),
        ("kn-IN-Wavenet-B", "Kannada (kn-IN-Wavenet-B)"),
        ...
        ("lv-lv-Standard-A", "Latvian (lv-lv-Standard-A)"),
        ("ml-IN-Standard-A", "Malayalam (ml-IN-Standard-A)"),
        ("ml-IN-Standard-B", "Malayalam (ml-IN-Standard-B)"),
        ("ml-IN-Wavenet-A", "Malayalam (ml-IN-Wavenet-A)"),
        ("ml-IN-Wavenet-B", "Malayalam (ml-IN-Wavenet-B)"),
        ...
        ("ro-RO-Wavenet-A", "Romanian (ro-RO-Wavenet-A)"),
        ...
        ("sr-rs-Standard-A", "Serbian (sr-rs-Standard-A)"),
        ...
        ("ta-IN-Wavenet-A", "Tamil (ta-IN-Wavenet-A)"),
        ("ta-IN-Wavenet-B", "Tamil (ta-IN-Wavenet-B)"),
        ...
        ("yue-HK-Standard-A", "Cantonese (yue-HK-Standard-A)"),
        ("yue-HK-Standard-B", "Cantonese (yue-HK-Standard-B)"),
        ("yue-HK-Standard-C", "Cantonese (yue-HK-Standard-C)"),
        ("yue-HK-Standard-D", "Cantonese (yue-HK-Standard-D)"),
    ]
