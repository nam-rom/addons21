...
from .patch import AddonManagerUpdatePatcher
...
class AnkiWebUpdateHandler:
    @staticmethod
    def disable_updates(package_name: str):
        try:
            patcher = AddonManagerUpdatePatcher(package_name)
            patcher.patch()
        except Exception:
            safe_print("Could not disable ankiweb updates")
